        ...
        >
          ...
          >
            <div className="flex-1  lg:max-w-[170px]">
              <div className="capitalize text-[20px] lg:text-[22px] font-normal font-primary lg:text-white mb-[22px]">
                {contact.title}
              </div>
            ...
            <div className="flex-1 lg:max-w-[280px] mb-12 ">
              <div className="capitalize text-[20px] lg:text-[28px] font-normal font-primary lg:text-white mb-[22px]">
                {social.title}
              </div>
              <Socials />
            </div>
