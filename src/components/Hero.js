...
const Hero = () => {
  ...
  return (
    <section className=" min-h-[980px] bg-cover bg-hero">
      <Header />
      <div className="conatiner mx-auto  min-h-[980px] flex justify-center items-center ">
        {/* text */}
        <motion.div
          variants={staggerContainer(0.3, 1)}
          initial="hidden"
          whileInView={"show"}
          className="text-center flex flex-col item-center"
        >
          <motion.div
