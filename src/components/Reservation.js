    ...
    <section className=" relative top-96 z-30 pb-20 lg:py-[100px]">
      <div className="container mx-auto">
        ...
        >
          ...
          <motion.p
            variants={fadeIn("up", "tween", 0.3, 1.6)}
          ...
          <div className="flex  flex-col lg:flex-row gap-y-4 items-center justify-between mb-8">
            <div className="">
              <div className=" flex items-center gap-x-[10px] font-semibold text-dark text-base mb-3">
                <FaCalendar />
                <div className="capitalize">choose date</div>
              </div>
              <DatePicker
                className="input"
                selected={startDate}
            ...
            <div>
              <div className="flex items-center gap-x-[10px] font-semibold text-dark text-base mb-3">
                <FaClock />
                <div className="capitalize">choose time</div>
              </div>
              <TimePicker
                className="input"
                clearIcon={false}
            ...
            <div>
              <div className=" flex items-center gap-x-[10px] font-semibold text-dark text-base mb-3">
                <FaUsers />
                <div className="capitalize">how many people?</div>
              </div>
