...
const Menu = () => {
  ...
  return (
    <section className=" min-h-[780px]">
      <div className="bg-green-300 h-[780px] bg-menu absolute w-full max-w-[1800px] -z-0">
        {" "}
      </div>
      {/*text */}
      ...
      >
        <div className="container mx-auto text-white">
          <div className="lg:-mt-24 min-h-[590px] z-30 mb-8 md:mb-5 xl:mb-16">
                ...
                return (
                  <div key={index}>
                    <div className="flex flex-row lg:flex-col h-full">
                      {/* reverse order for first and last img */}
                      <div
                      ...
                      <div className="flex flex-1 flex-col bg-white text-black justify-center px-6 lg:p-12 lg:max-h-[250px] xl:max-h-max">
